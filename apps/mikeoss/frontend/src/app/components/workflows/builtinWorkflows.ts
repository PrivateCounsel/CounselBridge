...
const counselBridgeWorkflow = (
    ...
    type: "assistant",
    practice,
    prompt_md: counselBridgePrompt(title, plugin, description, routes),
    columns_config: null,
});

const COUNSELBRIDGE_CLAUDE_WORKFLOWS: MikeWorkflow[] = [
    counselBridgeWorkflow(
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-corporate",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-litigation",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-employment",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-privacy",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-ai-governance",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-ip",
        "Claude Legal - IP",
        "IP",
        "ip-legal",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-product",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-regulatory",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-legal-clinic",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-law-student",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-vendor-agreement-review",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-saas-msa-review",
    ...
    counselBridgeWorkflow(
        "builtin-counselbridge-claude-legal-dpa-review",
