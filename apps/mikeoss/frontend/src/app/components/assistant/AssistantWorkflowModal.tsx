...
const COUNSELBRIDGE_WORKFLOW_PREFIX = "builtin-counselbridge-";
const COUNSELBRIDGE_SOURCE_LABEL = "Connected by CounselBridge";

function workflowSourceLabel(workflow: MikeWorkflow): string {
    if (workflow.id.startsWith(COUNSELBRIDGE_WORKFLOW_PREFIX)) {
        return COUNSELBRIDGE_SOURCE_LABEL;
    }
    return workflow.is_system ? "Built-in" : "Custom";
}
